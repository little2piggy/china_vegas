<?php session_start(); 
	...
	if($_REQUEST['pd_id'] == 1){
		...
		unset($_REQUEST['pd_id']);
	}
	else{
		$_SESSION['object'] = $_WDS['so_ttl'].":&nbsp;".$_REQUEST['ht_name']." - ".$_REQUEST['pd_name'];
	}
...
<meta name="description" content="Your Description Here" />
	...
	<title><?php echo $_WDS['company_ttl']." | ".$_WDS['contact_ttl']; ?></title>
</head>
<body class="bgbody">
    ...
    <p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p>
    	...
    	<div class="bgwhite" id="div_b">
            ...
            <div class="htl_b" style="margin-left: 50px; width:550px;">
                ...
                <?php include_once("main_contact.php"); ?>
                </div>
            </div>
            <p>&nbsp;</p>
         </div>
...
<div class="wrap_main_b">
	<div id="head_main_b">
          <div id="ttl_b"><span class="ttl_word_b"><img src="pix/contact_us.png" border="0" /></span></div><div><img src="pix/head_main_contact.png" border="0" /></div>
