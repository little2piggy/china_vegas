...
<meta name="description" content="Your Description Here" />
	...
	<title><?php echo $_WDS['company_ttl']." | ".$_WDS['links_ttl']; ?></title>
</head>
<body class="bgbody">
...
<div class="wraper_b">	
    ...
    <p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p>
        <div class="htl_b" style="margin: 50px; width:750px;">
            <?php include_once("main_sites.php"); ?>
        </div>
        <p>&nbsp;</p>
    </div>
</div>
...
<div class="wrap_main_b">
	<div id="head_main_b">	
          <div id="ttl_b"><span class="ttl_word_b"><img src="pix/partner_sites.png" border="0" /></span></div>
          <div><img src="pix/head_main_partner_sites.png" border="0" /></div>
